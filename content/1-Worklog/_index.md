...
Typically, a worklog is carried out over **12 weeks** (throughout the internship period) with weekly contents as follows:
...
**Week 6:** [REST API routing setup using API Gateway and Lambda](1.6-week6/)
