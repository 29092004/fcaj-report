...
![Budgets Console](/images/6-Operations-Security/6.4-Cost-Budget/budgets-console.png)

2. Click **Create budget**

3. Chọn **Customize (advanced)**

![Loại Budget](/images/6-Operations-Security/6.4-Cost-Budget/budget-type.png)
...
![Cấu hình Budget](/images/6-Operations-Security/6.4-Cost-Budget/budget-config.png)
...
![Bộ lọc Budget](/images/6-Operations-Security/6.4-Cost-Budget/budget-filters.png)
...
![Cấu hình Cảnh báo](/images/6-Operations-Security/6.4-Cost-Budget/alert-config.png)
...
![Budget đã tạo](/images/6-Operations-Security/6.4-Cost-Budget/budget-created.png)
...
![Cost Explorer](/images/6-Operations-Security/6.4-Cost-Budget/cost-explorer.png)

3. Xem **xu hướng chi phí hàng ngày** để phát hiện đợt tăng bất thường:

![Xu hướng Hàng ngày](/images/6-Operations-Security/6.4-Cost-Budget/daily-trend.png)
