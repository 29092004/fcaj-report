...
### A. Đăng ký tài khoản (`registerWithEmail`)
...
### B. Xác nhận đăng ký (`confirmRegister`)
...
### C. Đăng nhập hệ thống (`loginWithEmail`)
...
## 2. Cấu hình Cognito (Configuration)
...
## 4. Triển khai Cognito (Deployment)
